...
<body>
  ...
  <section id="intro"><div>
    <div id="disc"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="js" viewBox="0 0 630 630">
      <g>
    ...
    </svg><div id="info"><span>25-27 JANUARY 2018<br/>SINGAPORE</span></div>
  </div></section>
  ...
  <section class="page page0 visible"></section>

  <section class="page page1" id="about">
    <p>
      <br/><br/>
      <span id="slogan">"It's a conference a year ahead of itself.<br/>It really is ... next years conference!"</span>
      <!--<span id="counter" class="hidden">
        <br/><br/><br/>
  ...
  <section class="page page2" id="updates">
    <div>
  ...
  <section class="page page3" id="footer">
    <div>
      <div>
        <p>
  ...
  CountDownTimer('Fri, 18 Aug 2017 15:00:00 +0800', 'countdown');
    ...
    for(var i = 0; i < 34000; i++) {
      if (i % 800 === 500) {
        randomtext += '<span style="color:rgba(255,255,255,0.06);">JSCONF.ASIA</span>'
      } else if (i % 1700 === 40) {
        randomtext += '<span style="color:rgba(255,255,255,0.06);">SINGAPORE</span>'
      }
      randomtext += Math.floor(Math.random()*(9-0+1)+0).toString();
    }

    document.getElementById('bodyheight').innerHTML = randomtext + randomtext + randomtext + randomtext + randomtext + randomtext
